...
local CiderRunMode = {};CiderRunMode.runmode = 'RUN';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/ys/Library/Application Support/luaglider2/dev";local SOCKET_PORT=48872;local GLIDER_MAIN_FOLDER= "/Users/ys/work/gwork/lua";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()

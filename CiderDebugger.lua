...
local CiderRunMode = {};CiderRunMode.runmode = 'PROFILE';CiderRunMode.assertImage = true;CiderRunMode.userdir = "/Users/ys/Library/Application Support/luaglider2/dev";local SOCKET_PORT=38665;local GLIDER_MAIN_FOLDER= "/Users/ys/work/gwork/lib";local useNativePrint= false;local snapshotInterval= -1;local snapshotInterval= -1;local fileFilters= {"CiderDebugger.lua",};local startupMode= "require";local function shouldDebug()
